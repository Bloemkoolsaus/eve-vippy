	...
	class Connection
	{
		...
		function store($doCopy=true)
		{
			...
			$data = array(	"chainid"		=> $this->chainID,
							...
							"fromwhtypeid"	=> ($this->fromWHTypeID)?$this->fromWHTypeID:null,
							"towhtypeid"	=> ($this->fromWHTypeID)?$this->toWHTypeID:null,
							"kspacejumps"	=> ($this->kspaceJumps)?$this->kspaceJumps:null,
