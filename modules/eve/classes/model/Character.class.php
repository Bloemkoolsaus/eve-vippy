...
namespace eve\model
{
	class Character
	{
		...
		function refeshNeeded() {
			\AppRoot::debug("Do we need a token refresh? : " . $this->crest_expires < time() + CREST_TIME_OFFSET);
			return ($this->crest_expires < time() + CREST_TIME_OFFSET);
		}
